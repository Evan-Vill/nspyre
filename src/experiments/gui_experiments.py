...
import nv_experiments_12_13_24
...
class ExpWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.odmr_params_defaults = [12, 10, 2.87e9, 100e6, 30, 1e-9, 10e-6]
...
#         return params
    ...
    def run(self):
        ...
        if self.daq_b1.isChecked(): # digitizer settings
            reload(nv_experiments_12_13_24)
            # call the function in a new process
            self.run_proc.run(
            run_experiment,
            exp_cls = nv_experiments_12_13_24.SpinMeasurements,
