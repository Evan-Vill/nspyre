        ...
        main_widget = MainWidget(
            {
                ...
                'Experiments': MainWidgetItem(gui_experiments_no_dig, 'ExpWidget', stretch = (1, 1)),
                ...
                'Plots': {
                    'FlexLinePlot': MainWidgetItem(
                        gui_experiments_no_dig,
                        'FlexLinePlotWidgetAllDefaults',
                        stretch=(100, 100),
                    ),
                },
                'Fitter': MainWidgetItem(gui_experiments_no_dig, 'FitterWidget', stretch = (1, 1)),                
