...
class FIFO(): 
    ...
    def convert_data(self):
        ...
        return (((self.raw_data/np.abs(self.max_value))+self.conversion_offset)*self.conversion_amp)
        # self.conversion_offset=self.raw_data[0][0]/10000
        # print(self.conversion_offset)
        # return (self.raw_data/np.abs(self.max_value)-self.conversion_offset)
    ...
    def acquire(self):
        ...
        return(self.voltage_data) #self.raw_data ) #,self.data_voltage)
