...
class FIFO(): 
    ...
    def config(self):
        ...
        # setup card mode
        self.card.card_mode(spcm.SPC_REC_FIFO_BOXCAR) # SPC_REC_FIFO_MULTI
        self.card.set_i(spcm.SPC_BOX_AVERAGES, 32)
        ...
        self.multiple_recording.memory_size(self.mem_size*48)
