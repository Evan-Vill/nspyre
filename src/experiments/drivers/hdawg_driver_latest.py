...
{self.create_iq_pulses(1, 1, "I", 2, "Q")} waitWave();""")
            ...
            case 'CW traditional ODMR':           
                ...
                awg_pulses = [f"""repeat({kwargs['runs']}){{
{self.create_iq_pulses(1, 1, "I", 2, "Q")} waitWave();}}"""]
                
                iter_repeat = [self.repeat(kwargs['iters'])] 

                points_repeat = [self.repeat(kwargs['num_pts'])]

                iters_end = [f"}}}}"]

                self.awg_iq_program_text = "\n".join(i_wave + q_wave + i_phase + q_phase + iter_repeat + points_repeat + awg_pulses + iters_end)
            ...
            case 'Rabi':           
                ...
                self.awg_iq_program_text = "\n".join(i_phase + q_phase + i_waves + q_waves + iter_repeat + runs_repeat + awg_pulses + iters_end)
...
repeat(1){{{self.create_iq_pulses(1, 1, "I_plus1", 2, "Q_plus1")} waitWave();}}}}""")
                ...
                self.awg_iq_program_text = "\n".join(i_wave_minus1 + q_wave_minus1 + i_wave_plus1 + q_wave_plus1 + iter_repeat + runs_repeat + awg_pulses + iters_end)
...
{self.create_iq_pulses(1, 1, "I_pihalf_x", 2, "Q_pihalf_x")} waitWave();}}""")
                ...
                self.awg_iq_program_text = "\n".join(i_wave_pihalf_x + q_wave_pihalf_x + i_wave_pihalf_y + q_wave_pihalf_y + 
                                             ...
                                             iter_repeat + runs_repeat + awg_pulses + iters_end)
...
{self.create_iq_pulses(1, 1, "I_pihalf_x", 2, "Q_pihalf_x")} waitWave();}}}}""")
                ...
                self.awg_iq_program_text = "\n".join(i_wave_pihalf_x + q_wave_pihalf_x + i_wave_pihalf_y + q_wave_pihalf_y + 
                                             i_wave_pi_x + q_wave_pi_x + i_wave_pi_y + q_wave_pi_y + 
                                             iter_repeat + runs_repeat + awg_iq_pulses + iters_end)
...
repeat(4){{{self.create_pulses(1, 1, "waveRF")} waitWave();}}""")
                ...
                self.awg_program_text = "\n".join(awg_wave + iter_repeat + runs_repeat + awg_pulses + iters_end)
...
{self.create_pulses(1, 1, f"w{i}")}}}""")
                ...
                self.awg_program_text = "\n".join(awg_waves + iter_repeat + runs_repeat + awg_pulses + iters_end)
...
{self.create_pulses(1, 1, f"w{i}")} {self.create_pulses(1, 1, "waveRF")} {self.create_pulses(1, 1, "waveRF")}}}""")
                ...
                iters_end = [f"}}}}"]
                self.awg_program_text = "\n".join(awg_wave + awg_waves + iter_repeat + runs_repeat + awg_pulses + iters_end)
...
{self.create_pulses(1, 1, f"waveCD{i}")}}}""")
                ...
                self.awg_program_text = "\n".join(awg_wave_DEER + awg_CD_waves + iter_repeat + runs_repeat + awg_pulses + iters_end)
...
{self.create_iq_pulses(1, 1, "I_pihalf_y", 2, "Q_pihalf_y")} waitWave();}}""")
        ...
        print("control groups? ", self.control_both_groups)
